...
<p>Let's see how much, or how little, the time taken to invoke the JVM might contribute to the <a href="http://benchmarksgame.alioth.debian.org/play.html#measure">usual</a> Java program times shown in the benchmarks game. Here are some <b>additional</b> (Intel&#174; Q6600&#174; quad-core) elapsed time measurements, taken after the Java programs started and before they exited.</p> 
...
<p>Compare these additional measurements against the <a href="http://benchmarksgame.alioth.debian.org/play.html#measure">usual</a> Java program measurements shown in the benchmarks game --</p>
