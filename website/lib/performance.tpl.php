...
$elapsed_nav_open = $sort_nav.'elapsed">';
$elapsed_nav_close = '</a>';
$mem_nav_open = $sort_nav.'kb">';
$mem_nav_close = '</a>';
$gzbytes_nav_open = $sort_nav.'gz">';
$gzbytes_nav_close = '</a>';
$cpu_nav_open = $sort_nav.'fullcpu">';
$cpu_nav_close = '</a>';
...
<article>
  ...
  <section>
    <div>
      <h3>program source code, command-line and measurements</h3>
    </div>
    <table>
<?
echo "      <tr>\n";
...
echo "        <th", $mem_th,">", $mem_nav_open, "KB", $mem_nav_close, "\n";
...
echo "          <li", $mem_th,">", $mem_nav_open, "by KB", $mem_nav_close, "\n";
